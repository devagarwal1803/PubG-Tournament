...
class SignUpForm(UserCreationForm):
    ...
    mobile = forms.IntegerField(label=_('Mobile Number'), help_text=_('Required. Enter an existing mobile number.'))
    m1 = forms.CharField(label=_('Member 1'),help_text=_('Required'))
    m2 = forms.CharField(label=_('Member 2'),help_text=_('Required'))
    m3 = forms.CharField(label=_('Member 3'),help_text=_('Required'))
    m4 = forms.CharField(label=_('Member 4'),help_text=_('Required'))
    email = forms.EmailField(label=_('Email'), help_text=_('Required. Enter an existing email address.'))
    first_name=forms.CharField(label=_('Team Name'), help_text=_('Required.') )
...
class ChangeProfileForm(forms.Form):
    first_name = forms.CharField(label=_('Team name'), max_length=30, required=False)
